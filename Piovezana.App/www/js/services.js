...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://fir-18152.firebaseio.com/"),
    refCart = new Firebase("https://fir-18152.firebaseio.com/cart"),
    refUser = new Firebase("https://fir-18152.firebaseio.com/users"),
    refCategory = new Firebase("https://fir-18152.firebaseio.com/category"),
    refOrder = new Firebase("https://fir-18152.firebaseio.com/orders"),
    refFeatured = new Firebase("https://fir-18152.firebaseio.com/featured"),
    refMenu = new Firebase("https://fir-18152.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
